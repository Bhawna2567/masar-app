...
var PRACTICE_PASSAGES = [
 {title:"The Lost Kitten", text:"Sara found a small kitten under a tree. It was cold and hungry, so she gave it warm milk and a soft box to sleep in. The next day, Sara put up a sign near her house. Soon a boy came to the door — the kitten was his! He had been looking for it all week. He thanked Sara and promised to take good care of it. Sara had never had a pet of her own, so looking after the tiny kitten made her very happy. She fed it twice, kept it warm through the night, and even gave it a gentle name. When the boy took it home, Sara felt a little sad, but she was glad the kitten was safe with its family again.",
  qs:[
 ...
 {title:"Plastic in the Sea", text:"Every year, tonnes of plastic reach the ocean. Sea animals sometimes think the plastic is food and eat it, which can make them very ill. Because of this, many countries are now banning single-use bags and asking people to recycle. Small changes, made by many people, can protect the sea for the future. Scientists have found plastic inside fish, turtles and even large whales. Some of it takes hundreds of years to break down, so the rubbish we drop today may still be in the sea long after we are gone. That is why picking up litter and using cloth bags can help more than people think.",
  qs:[
 ...
 {title:"The Big Match", text:"Ali's football team was losing 1–0 and he felt very tired. Even so, he did not stop trying. In the last minute, his friend passed him the ball. Ali kicked it hard and scored! The game ended 1–1. His team was proud because they never gave up, even when they were tired. The crowd had grown quiet as the clock ran down, sure that the game was lost. When Ali's shot hit the back of the net, his teammates ran to hug him and the fans cheered loudly. On the way home, the coach reminded them that effort matters just as much as winning.",
  qs:[
 ...
 {title:"The Value of Sleep", text:"Many students stay up late and sleep too little. Research shows that sleep helps the brain store what we learn, and it improves memory and mood. Teenagers need about eight to ten hours a night. Simple habits — a regular bedtime and less screen time before bed — can make a real difference to how well students think and feel. When we sleep too little, it becomes harder to concentrate, remember facts and control our feelings. Many students feel tired in the morning because they used their phones late into the night. Turning off screens an hour before bed and keeping the room dark can help the body fall asleep more easily.",
  qs:[
 ...
 {title:"A Surprising Discovery", text:"When Mariam opened the dusty old box in the attic, she did not expect to find anything special. Inside were letters tied with ribbon, written by her great-grandmother fifty years ago. As she read them, Mariam learned about family members she had never known, and she felt a deep connection to her past. The ink on the letters had faded, but Mariam could still read the careful handwriting. Her great-grandmother had written about her childhood, her hopes and the small joys of everyday life. Mariam decided to keep the letters safely and to share the stories with the rest of her family.",
  qs:[
...
var READING_BANK = {
 main_idea:[
  {title:"City Parks", text:"City parks give people a place to relax, exercise and meet friends. Trees in parks also clean the air and give shade on hot days. Many families visit parks at the weekend to play and enjoy nature. Some parks also have playgrounds, ponds and quiet paths where people can walk or ride bicycles. Doctors say that spending time outdoors in green spaces is good for both the body and the mind. For this reason, cities that plan carefully always try to leave room for parks between the busy roads and buildings.",
   qs:[
  ...
  {title:"Recycling at Home", text:"Recycling helps our planet in simple ways. When we recycle paper, plastic and glass, less rubbish goes to landfill. It also saves energy and keeps our streets clean. Before we throw something away, it is worth asking whether it can be used again. Sorting bottles, cans and paper into the right bins takes only a moment, but it makes a big difference over a year. When a whole neighbourhood recycles together, far less waste ends up buried in the ground.",
   qs:[
  ...
  {title:"A Healthy Breakfast", text:"Eating breakfast is good for your body and mind. It gives you energy for the morning and helps you think clearly at school. Children who eat breakfast often do better in class. A good breakfast might include fruit, eggs, bread or yoghurt, along with a glass of water or milk. Skipping the first meal often leaves people feeling hungry and grumpy long before lunch. Taking just ten minutes to eat in the morning can make the whole school day feel easier.",
   qs:[
  ...
  {title:"The School Library", text:"The school library is a special place to learn. Students can borrow books, read quietly and find facts for their projects. A good library helps everyone become a better reader. Along the shelves you can find storybooks, science books and colourful magazines for every age. The librarian is always ready to help students find exactly what they need for a project. Because it is calm and quiet, the library is also a perfect place to think and to study.",
   qs:[
  ...
  {title:"Move Every Day", text:"Exercise keeps our bodies strong and healthy. Running, swimming and playing games make our hearts strong and give us energy. Even a short walk each day is good for us. You do not need special equipment to stay active — walking, skipping or playing in the park all count. Being active also helps us sleep better at night and feel happier during the day. Doctors suggest that children should move and play for about an hour every single day.",
   qs:[
 ...
 inference:[
  {title:"The Wet Umbrella", text:"When Layla came into the classroom, her umbrella was dripping and her shoes left wet marks on the floor. She shivered and rubbed her cold hands together. She hurried to her seat and tried to warm her fingers by breathing on them. Outside, the sound of falling rain tapped steadily against the classroom window. Her friend passed her a dry tissue and smiled, and slowly Layla began to feel better.",
   qs:[
  ...
  {title:"The Big Smile", text:"When Yousef saw the wrapped box on the table, his eyes grew wide and he jumped up and down. He hugged his mother tightly and could not stop grinning. He had been hoping for this present for weeks and could hardly believe it was finally his. His mother laughed at how excited he was and told him to open it carefully. Inside was exactly what he had wished for, and Yousef thanked her again and again.",
   qs:[
  ...
  {title:"The Empty Plate", text:"Hana's stomach was making loud noises during the long lesson. She kept looking at the clock and thinking about lunch. When the bell finally rang, she ran straight to the canteen. She had eaten her breakfast very early that morning and had been busy ever since. As the teacher spoke, Hana found it harder and harder to think about anything but food. The moment lunch began, she felt much better and promised herself she would eat a bigger breakfast next time.",
   qs:[
  ...
  {title:"A Long Day", text:"After the football match, Sami's legs felt heavy and his eyes kept closing. He yawned again and again on the way home and fell asleep before dinner. He had run up and down the field for the whole game without stopping to rest. By the time he reached the front door, all he wanted was to lie down. His mother covered him with a blanket, and Sami was asleep within minutes.",
   qs:[
  ...
  {title:"Before the Stage", text:"Maha's hands were shaking and her mouth felt dry as she waited behind the curtain. She peeked at the large crowd and took a deep breath. She had practised her lines many times at home, but the crowd still made her nervous. She reminded herself to speak slowly and to look at a friendly face in the audience. When the music began, Maha stepped forward, and after the first few words her fear started to fade.",
   qs:[
 ...
 compare:[
  {title:"Two Short Articles", text:"Text 1: Cats make good pets. They are quiet, they clean themselves, and they do not need long walks. They also purr softly and can be very gentle with children.\nText 2: Dogs make good pets too. They are friendly and playful, but they need daily walks and lots of space. Many people say that having any pet, whether a cat or a dog, teaches children how to be kind and responsible.",
   qs:[
  ...
  {title:"Two Seasons", text:"Text 1: Summer is warm and sunny. People swim at the beach and eat cold ice cream. The days are long, so children can play outside until late in the evening.\nText 2: Winter is cold and cloudy. People wear warm coats and drink hot tea. Whichever season people prefer, each one brings its own special activities and food.",
   qs:[
  ...
  {title:"Two Ways to Travel", text:"Text 1: A bus can carry many people at once. It follows a set route and stops at bus stops. It is a cheap way to travel and is helpful for people who cannot drive.\nText 2: A bike carries one person. It can go almost anywhere and is good exercise. Both the bus and the bike help people move around town without needing a car of their own.",
   qs:[
  ...
  {title:"Two Fruits", text:"Text 1: Apples are sweet and crunchy. They can be red or green and grow on trees. They make a healthy snack and can be sliced into a lunchbox easily.\nText 2: Oranges are juicy and a little sour. They are orange in colour and full of vitamin C. Eating a mix of different fruits every day gives our bodies the vitamins they need to stay strong.",
   qs:[
  ...
  {title:"In the Sky", text:"Text 1: The sun shines in the day. It gives us light and heat and helps plants grow. Without its warmth, the Earth would be far too cold for living things.\nText 2: The moon shines at night. It gives soft light and changes shape through the month. Together, the sun and the moon mark the difference between our days and our nights.",
   qs:[
 ...
 summary:[
  {title:"The School Trip", text:"Last week, Class 6 visited a science museum. They saw a model of the solar system, watched a short film about space, and tried a fun experiment with magnets. Everyone said it was the best trip of the year. On the bus, the teacher explained what they would see, and the students could hardly sit still. At the museum, a guide answered their many questions about planets and stars. When they returned to school, everyone wrote about their favourite part of the day.",
   qs:[
  ...
  {title:"A Day at the Zoo", text:"On Friday, the class went to the zoo. They saw tall giraffes, watched the monkeys play, and fed the goats. The children agreed it was a wonderful day. They started at the giraffe enclosure, where the tall animals reached high into the trees for leaves. After lunch, the class visited the reptile house and the colourful birds. By the end of the afternoon, everyone was tired but very happy.",
   qs:[
  ...
  {title:"Growing Tomatoes", text:"Grandpa planted tomato seeds in spring. He watered them every day and pulled out the weeds. By summer, the plants were full of red tomatoes. Each morning, Grandpa checked the little plants and made sure the soil was not too dry. Slowly, small yellow flowers appeared, and then tiny green tomatoes grew in their place. By the time they turned red, the whole family was ready to enjoy them in a fresh salad.",
   qs:[
  ...
  {title:"The Night of the Storm", text:"A strong storm hit the town at night. The wind broke branches and the rain flooded the streets. In the morning, everyone helped to clean up the mess. During the night, the thunder was so loud that many people could not sleep. Some houses lost their electricity, and the streets were covered with leaves and water. As soon as the sun rose, neighbours came out with brushes and bags to help each other tidy up.",
   qs:[
  ...
  {title:"The New Bakery", text:"A new bakery opened on our street. It sells fresh bread, sweet cakes and warm pies. Many neighbours visit every morning to buy breakfast. The smell of fresh bread drifted down the street and made everyone feel hungry. The baker worked from very early in the morning so that everything was ready by breakfast time. Soon the little shop became one of the most popular places in the whole neighbourhood.",
   qs:[
 ...
 purpose_tone:[
  {title:"Save Water!", text:"Please remember to turn off the tap while brushing your teeth. Every drop counts! Together, we can protect our precious water and help our community. A running tap can waste many litres of clean water in just a few minutes. By taking shorter showers and fixing leaks quickly, each family can save a surprising amount. Small habits, when everyone follows them, add up to a big difference for our town.",
   qs:[
  ...
  {title:"Plant a Tree", text:"Come and join our tree-planting day this Saturday! Bring your friends and help make our town greener and more beautiful. Together we can make a real difference. Trees give us shade, clean the air and provide homes for birds and insects. On the day, there will be tools, water and friendly helpers to show you what to do. Do not forget to wear old clothes and bring a hat, because we will be working outside all morning.",
   qs:[
  ...
  {title:"How to Wash Your Hands", text:"Wet your hands with clean water. Rub soap over your hands for twenty seconds. Then rinse well and dry them with a clean towel. Be sure to clean between your fingers and under your nails, where germs like to hide. Washing your hands well is one of the easiest ways to stop illness from spreading. Remember to do it before you eat and after you use the bathroom.",
   qs:[
  ...
  {title:"The Dancing Robot", text:"Once upon a time, a small robot loved to dance. It spun and hopped across the kitchen floor, making the whole family laugh with joy. Its little lights blinked in time with the music as it twirled around and around. The children clapped along, and even the cat watched with wide, curious eyes. From that day on, every evening ended with the robot's cheerful little dance.",
   qs:[
  ...
  {title:"Careful by the Pool", text:"Please do not run near the swimming pool. The wet floor is slippery and you could fall and hurt yourself. Walk slowly to stay safe. Splashes of water make the tiles smooth and easy to slip on. Lifeguards ask everyone to walk, not run, so that nobody gets hurt near the edge. Following these simple rules keeps the pool a safe and happy place for all.",
   qs:[
 ...
 prediction:[
  {title:"Dark Clouds", text:"Omar looked up at the sky. Dark grey clouds were gathering and the wind began to blow harder. He quickly picked up his bag and started walking faster towards home. A few cold drops of rain landed on his arms as he hurried along the path. He wished he had brought his umbrella, but he had left it at home that morning. Just as he reached his front door, the sky opened and the rain poured down.",
   qs:[
  ...
  {title:"The Little Seed", text:"Amina planted a seed in a pot and put it on the sunny windowsill. She watered it a little each day and watched the soil carefully. For several days nothing seemed to happen, and Amina wondered if the seed would grow at all. Then, one bright morning, a tiny green shoot pushed up through the soil. She was so excited that she called her whole family to come and look.",
   qs:[
  ...
  {title:"Dinner Time", text:"Dad put a pot of soup on the stove and turned on the heat. Soon small bubbles began to appear and steam rose into the air. The kitchen filled with a warm, tasty smell that made everyone feel hungry. Dad stirred the soup slowly so that it would not stick to the bottom of the pot. When it was ready, the whole family sat down together to enjoy the meal.",
   qs:[
  ...
  {title:"Sleepy Time", text:"The baby rubbed his eyes and gave a big yawn. His mother held him gently and began to sing a soft, slow song. The room was warm and quiet, with only the soft sound of the lullaby. Little by little, the baby's eyes grew heavy and his tiny hands stopped moving. Before the song was finished, he had drifted off into a peaceful sleep.",
   qs:[
  ...
  {title:"At the Starting Line", text:"The runners lined up on the track and bent down low. The man raised the whistle to his lips and everyone went quiet. Every runner stared straight ahead, waiting for the signal to begin. Their hearts were beating fast and their muscles were ready to spring forward. The moment the whistle blew, they burst from the line and raced down the track.",
   qs:[
 ...
 context:[
  {title:"The Brave Firefighter", text:"The firefighter was fearless as she ran into the burning building to rescue the trapped family. Afterwards, everyone praised her courage. Thick smoke filled the rooms, but she did not turn back until every person was safe outside. The family thanked her with tears in their eyes as the fire engine's lights flashed in the street. Stories like hers remind us how much we depend on the people who keep us safe.",
   qs:[
  ...
  {title:"The Enormous Elephant", text:"The enormous elephant was so large that it blocked the whole path. The children stared up at the huge animal in wonder. Its huge ears flapped slowly and its long trunk swung from side to side. The children had never seen an animal so tall and so heavy in real life. They watched in silence until the great creature finally moved off the path and into the trees.",
   qs:[
  ...
  {title:"A Delicious Meal", text:"The food smelled so delicious that everyone rushed to the table. They devoured the warm rice and tender meat until the plates were empty. The table was covered with warm dishes that had taken hours to prepare. Everyone talked and laughed as they passed the plates around and filled their bowls. By the end, not a single grain of rice was left, and everybody thanked the cook.",
   qs:[
  ...
  {title:"The Ancient Castle", text:"The ancient castle had stood for a thousand years. Its walls were crumbling and moss covered the old grey stones. Long ago, kings and soldiers had walked through its great stone halls. Now only birds nested in the towers, and visitors came to imagine its past. Standing among the old walls, it was easy to picture how grand the castle must once have been.",
   qs:[
  ...
  {title:"The Freezing Morning", text:"It was a freezing winter morning. Ice covered the windows and the children shivered as they waited for the bus. Their breath made little clouds in the cold air as they stamped their feet to keep warm. The road was slippery, so everyone walked slowly and carefully. When the warm bus finally arrived, the children were very glad to climb aboard.",
   qs:[
 ...
 sequence:[
  {title:"Making Tea", text:"First, Sara boiled the water. Next, she put a tea bag in the cup. Then she poured the hot water over it. Finally, she added a little sugar and stirred. The warm cup felt lovely in her cold hands, and the sweet smell rose gently into the air.",
   qs:[
  ...
  {title:"Getting Ready", text:"First, Omar woke up and washed his face. Next, he put on his uniform. Then he ate his breakfast. Finally, he picked up his bag and left for school. By the time he stepped outside, he felt fresh, full and ready for the day ahead.",
   qs:[
  ...
  {title:"Planting a Flower", text:"First, Lina dug a small hole in the soil. Next, she dropped a seed inside. Then she covered it with earth. Finally, she watered it well. She placed the little pot in a sunny spot and hoped that soon a bright flower would grow.",
   qs:[
  ...
  {title:"Making a Sandwich", text:"First, Sami took two slices of bread. Next, he spread butter on them. Then he added cheese in the middle. Finally, he cut the sandwich in half. The two neat halves looked tasty on the plate, and Sami could not wait to eat them.",
   qs:[
  ...
  {title:"Time for Bed", text:"First, Nora brushed her teeth. Next, she put on her pyjamas. Then she read a short story. Finally, she turned off the light and slept. The room was calm and dark, and soon Nora was fast asleep under her warm blanket.",
   qs:[
 ...
 fact_opinion:[
  {title:"The Football Match", text:"The match started at 5 o'clock. The stadium held 20,000 people. I think football is the most exciting sport in the world, and everyone should watch it. The two teams wore red and blue shirts, and the referee blew his whistle to begin. In my opinion, watching a live match is far more exciting than watching one on television.",
   qs:[
  ...
  {title:"The New Library", text:"The library opened in 2020. It has more than five thousand books. I think it is the best building in our town, and everyone should visit it. It has three floors and a quiet room just for reading. I believe every child who visits will fall in love with books, and that makes it the finest place in town.",
   qs:[
  ...
  {title:"The Camel Race", text:"The camel race takes place every winter. Thousands of people come to watch. In my opinion, camels are the most beautiful animals in the world. The fastest camels can run as quickly as a car on a city road. In my opinion, no festival in the whole year is more exciting than race day.",
   qs:[
  ...
  {title:"The Old Bridge", text:"The old bridge is 200 metres long. It was built a hundred years ago. I think it is the prettiest bridge anyone has ever seen, and walking across it is wonderful. Cars are not allowed on it any more, so only people may cross on foot. I believe it is the most romantic spot in the whole town, and everyone should see it at sunset.",
   qs:[
 ...
 cause_effect:[
  {title:"The Broken Window", text:"Because the boys were playing football too close to the house, the ball hit the window and it broke. As a result, they had to pay for a new one. The loud crash brought the owner of the house straight outside. The boys felt sorry and admitted at once that it had been their fault. After that, they always played their games far away from people's windows.",
   qs:[
  ...
  {title:"The Melted Ice Cream", text:"Because the sun was very hot, the ice cream melted quickly. As a result, it dripped all over Sara's hand. Sara tried to lick it quickly, but it was melting faster than she could eat. Sticky drops fell onto the hot pavement and left little marks. Next time, she decided, she would eat her ice cream in the shade.",
   qs:[
  ...
  {title:"The Wilted Plant", text:"Because no one watered the plant for a week, its leaves turned brown and dry. As a result, the plant began to die. The family had gone away on holiday and forgotten to ask anyone to care for it. When they returned, they found the poor plant drooping in its dry pot. They watered it at once and hoped that it was not too late to save it.",
   qs:[
  ...
  {title:"The Late Bus", text:"Because there was heavy traffic, the school bus arrived late. As a result, the students missed the first lesson. The road was full of cars that were barely moving at all. By the time the bus reached the school, the first lesson had already begun. The students hurried to class and apologised quietly to their teacher.",
   qs:[
  ...
  {title:"The Winning Goal", text:"Because Khalid practised every day, he became a strong player. As a result, he scored the winning goal in the final match. Even on cold and rainy days, Khalid went outside to train with his ball. His hard work slowly turned him into one of the best players on the team. When the final whistle blew and his goal had won the match, his family cheered with pride.",
   qs:[
 ...
 theme:[
  {title:"The Ant and the Grain", text:"All summer the little ant worked hard to store grain, while the others only played. When winter came and food was scarce, only the ant had enough to eat. The others wished they had prepared too. Day after day, the ant carried heavy grains back to its nest while the others danced in the sun. When the cold arrived and the fields were bare, the ant stayed warm and well fed. The lazy ones finally understood that a little hard work in good times saves you in hard times.",
   qs:[
  ...
  {title:"The Two Friends", text:"Rami helped his friend carry a heavy bag up the hill, even though he was tired. Later, when Rami fell, his friend was there to help him up at once. They learned that kindness comes back to you. Neither boy asked for thanks; they simply helped because it was the right thing to do. Their friendship grew stronger with every kind act they shared. In time, everyone in the village spoke of how well the two friends looked after each other.",
   qs:[
  ...
  {title:"The Proud Rabbit", text:"A fast rabbit laughed at a slow turtle and boasted that no one could beat him. During the race, the rabbit stopped to rest, but the turtle kept going and won. The rabbit learned not to be too proud. So sure was he of winning that he lay down for a nap halfway through the race. The steady turtle passed him quietly and crossed the finish line first. From that day on, the rabbit never boasted again, and he learned to respect others.",
   qs:[
  ...
  {title:"The Honest Boy", text:"Faris found a wallet full of money on the street. Although he wanted the money, he handed it to the police. The owner was very grateful, and Faris felt proud that he had done the right thing. Although he could have kept the money he found, he chose to return it to its owner. The owner was so grateful that he told everyone about the boy's honesty. In the end, being truthful earned the boy far more than the money ever could.",
   qs:[
  ...
  {title:"Never Give Up", text:"Dana tried many times to solve the hard puzzle and kept making mistakes. Instead of quitting, she practised again and again until, at last, she solved it. She learned that patience brings success. Time after time she failed, but each time she stood up and tried once more. Slowly her efforts began to pay off, and what had seemed impossible became easy. She learned that patience and practice can beat almost any difficulty.",
   qs:[
 ...
 story_elements:[
  {title:"Nora and the Lost Key", text:"Nora was a curious girl who lived by the sea. One morning she could not find the key to her boat. She searched everywhere and, at last, found it under a pile of nets. Happily, she sailed out to fish. She searched her bag, her pockets and every corner of the room, but the key was nowhere to be found. Just as she was about to give up, she remembered leaving it beside the front door. With a sigh of relief, she picked it up and finally let herself in.",
   qs:[
  ...
  {title:"Sami and the Storm", text:"Sami was a brave boy who lived on a small farm. One night, a strong storm blew open the gate and the sheep ran out. Sami went into the rain and, one by one, led all the sheep safely back. Then he tied the gate shut. The wind howled and the rain beat hard against the windows all through the night. Sami felt afraid, but he stayed calm and helped his little sister feel safe. By morning the storm had passed, and the bright, quiet sky felt like a reward for their courage.",
   qs:[
  ...
  {title:"The Lost Homework", text:"Maryam was a hard-working student at Green Valley School. One morning she could not find her homework anywhere. She searched her bag and, at last, found it inside a library book. She handed it in just in time. He was sure he had put it in his bag, yet now the pages were nowhere in sight. After a worried search, he found the crumpled sheets under his bed at home. He handed the work in late, and promised himself he would be more careful from then on.",
   qs:[
  ...
  {title:"The Thirsty Traveller", text:"A tired traveller walked across the hot desert. He was very thirsty and could find no water. At last, he saw a well near some palm trees, drew up fresh water, and drank happily. The sun beat down on the dusty road, and his water bottle had been empty for hours. At last he spotted a well in the distance and hurried towards it with hope. The cool, fresh water was the best drink he had ever tasted.",
   qs:[
  ...
  {title:"The Broken Bike", text:"Zaid loved to cycle in his neighbourhood. One day the chain on his bike snapped and he could not ride. He asked his uncle, who showed him how to fix the chain. Soon Zaid was cycling again. The chain had slipped off and one tyre was completely flat. At first he felt like giving up, but instead he fetched his tools and set to work. After an hour of careful effort, the bike was fixed, and he rode off feeling proud of himself.",
   qs:[
 ...
 five_ws:[
  {title:"News: School Wins Prize", text:"Yesterday, Al Noor School in Ajman won the national science prize because its students built a clever solar robot. The award was given at a ceremony in Dubai. Teachers, parents and students gathered in the hall to celebrate the good news. The head teacher thanked everyone for their hard work throughout the year. The shining trophy will now stand proudly in the school entrance for all to see.",
   qs:[
  ...
  {title:"News: Beach Clean-Up", text:"On Saturday, students from Al Amal School cleaned Jumeirah Beach because they wanted to protect sea animals. They filled fifty bags with rubbish. Volunteers of all ages arrived early with gloves and large bags. Together they collected bottles, plastic and other litter from the sand. By the afternoon, the beach looked cleaner and brighter than it had in years.",
   qs:[
  ...
  {title:"News: A New Bridge", text:"Last month, the city of Sharjah opened a new bridge over the river so that traffic could move faster. Drivers were very pleased. The bridge will connect the two sides of the river for the very first time. Drivers who once took a long detour will now save many minutes on their journey. Local people say the new crossing will help both businesses and families.",
   qs:[
  ...
  {title:"News: The Science Fair", text:"On Wednesday, Al Falah School held a science fair in the main hall because the teachers wanted to show the students' projects. Many parents came to watch. Students showed clever projects, from model volcanoes to tiny working robots. Judges walked from table to table, asking questions and admiring the ideas. The winning team said they had spent many weekends preparing their experiment.",
   qs:[
  ...
  {title:"News: The Firefighters' Rescue", text:"Yesterday, firefighters in Abu Dhabi rescued a cat from a tall tree because a worried family had called for help. The cat was safe and well. The team reached the scene within minutes and worked quickly to bring everyone to safety. Neighbours watched anxiously until the last person was carried out unharmed. The mayor later praised the firefighters for their speed and bravery.",
   qs:[
