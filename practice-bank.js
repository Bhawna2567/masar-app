...
var GRAMMAR_BANK = {
 ...
 punct:[
  ...
  {q:"Which sentence is punctuated correctly?",options:["do you like tea","Do you like tea?","Do you like tea","do you like tea."],answer:1},
  {q:"Which end mark is needed? 'Watch out___'",options:[".","?","!",","],answer:2},
  {q:"Choose the correct sentence:",options:["she is my friend","She is my friend.","she is my friend.","She is my friend"],answer:1},
  {q:"Which end mark best fits? 'Where is my bag___'",options:[".","?","!",","],answer:1},
  {q:"Which sentence is correct?",options:["the sun is hot","The sun is hot.","the sun is hot.","The sun is hot"],answer:1},
  {q:"Which end mark is needed? 'I am so happy___'",options:[".","?","!",";"],answer:2}
 ],
 conj:[
 ...
 capital:[
  ...
  {q:"Which sentence has correct capital letters?",options:["we visit london in july.","We visit London in July.","we visit London in july.","We visit london in July."],answer:1},
  {q:"Which sentence is correct?",options:["my name is omar.","My name is Omar.","my name is Omar.","My name is omar."],answer:1},
  {q:"Choose the correctly capitalised sentence:",options:["i study english on tuesday.","I study English on Tuesday.","i study English on tuesday.","I study english on tuesday."],answer:1},
  {q:"Which is correct?",options:["we live near the red sea.","We live near the Red Sea.","we live near the Red sea.","We live near the red sea."],answer:1},
  {q:"Choose the correct sentence:",options:["fatima is from morocco.","Fatima is from Morocco.","fatima is from Morocco.","Fatima is from morocco."],answer:1},
  {q:"Which sentence is correct?",options:["eid is a happy time.","Eid is a happy time.","eid Is a happy time.","Eid Is A Happy Time."],answer:1}
 ],
 comma:[
  ...
  {q:"Choose the sentence with correct commas:",options:["I need pens books and a ruler.","I need pens, books and a ruler.","I, need pens books ruler.","I need, pens books ruler."],answer:1},
  {q:"Choose the correct sentence:",options:["After school we play.","After school, we play.","After school we, play.","After school we play,"],answer:1},
  {q:"Choose the correct sentence:",options:["No I do not agree.","No, I do not agree.","No I, do not agree.","No I do not agree,"],answer:1},
  {q:"Choose the correct sentence:",options:["We flew to Rome Italy.","We flew to Rome, Italy.","We flew to, Rome Italy.","We, flew to Rome Italy."],answer:1},
  {q:"Choose the correct sentence:",options:["When it rained we ran inside.","When it rained, we ran inside.","When, it rained we ran inside.","When it rained we ran, inside."],answer:1},
  {q:"Choose the sentence with a correct comma:",options:["My sister who is six sings well.","My sister, who is six, sings well.","My sister who is, six sings well.","My, sister who is six sings well."],answer:1}
 ],
 voice:[
 ...
 apos:[
  ...
  {q:"Choose the correct sentence:",options:["Thats my house.","That's my house.","Thats' my house.","That is's my house."],answer:1},
  {q:"Show possession: 'the ___ roof' (belonging to one house)",options:["houses","house's","houses'","house"],answer:1},
  {q:"Choose the correct sentence:",options:["This is Alis pen.","This is Ali's pen.","This is Alis' pen.","This is Ali pen's."],answer:1},
  {q:"What does 'the boys' team' mean?",options:["team of one boy","team of many boys","one boy team","no team"],answer:1},
  {q:"Choose the correct contraction of 'cannot':",options:["cant","can't","ca'nt","can,t"],answer:1},
  {q:"Choose the correct sentence:",options:["Theyre my friends.","They're my friends.","Theyre' my friends.","They are're my friends."],answer:1}
 ],
 clause:[
